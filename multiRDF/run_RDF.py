...
- log files in directory ./Logs
"""

from configparser import ConfigParser
import os,re,sys
import save_RDF as saverdf
import argparse
...
class RunRdf(object):
    ...
    def savelog(self):
        ...
        with open("./Logs/{}".format(logfilename),"w") as logf:
...
class ParamSet(object):
    ...
    def get_args(self,printargs=False):
        ...
        sys.argv=[sys.argv[0]]
        args=saverdf.parse_args(required=False)
